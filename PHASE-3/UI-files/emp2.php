...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-center"> 
      ...
      <h2 style="font-size: 40px;"><b>WELCOME EMPLOYEE!</b></h1>
        <ul style="text-align: left; font-size: 20px; font-family: Arial, Helvetica, sans-serif; ">
        <li>Employee can update and view the status of the courier</li>
        <li>Employee can delete the couriers that have been delivered to the customer</li>
        <li>Employee can recruit the delivery boys </li>
        </ul>
    </div>
  </div>
</div>
